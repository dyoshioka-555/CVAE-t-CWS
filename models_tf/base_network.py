...
class TransformerEncoder(GaussianEncoderBase):
    def __init__(
        self, ni, nh, nz, label_ni, label_nz, vocab_size, model_init, emb_init, device, nhead=4, num_layers=4
    ):
...
class TransformerDecoder(nn.Module):
    def __init__(self, ni, nh, nz, dropout_in, dropout_out, vocab, model_init, emb_init, device, bow_size, num_layers=1):
        ...
        self.label_linear = nn.Linear(2, 16, bias=False)
